...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MemberMetadata'
        db.create_table('memberinfo_membermetadata', (
        ...
        db.send_create_signal('memberinfo', ['MemberMetadata'])

        # Adding field 'GamingIDs.raptrID'
        db.add_column('memberinfo_gamingids', 'raptrID', self.gf('django.db.models.fields.CharField')(default=0, max_length=50, blank=True), keep_default=False)

        # Changing field 'GamingIDs.steamID'
        db.alter_column('memberinfo_gamingids', 'steamID', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        # Changing field 'GamingIDs.xboxID'
        db.alter_column('memberinfo_gamingids', 'xboxID', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        # Changing field 'GamingIDs.xfireID'
        db.alter_column('memberinfo_gamingids', 'xfireID', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        # Changing field 'GamingIDs.psnID'
        db.alter_column('memberinfo_gamingids', 'psnID', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))


    def backwards(self, orm):
        
        # Deleting model 'MemberMetadata'
        db.delete_table('memberinfo_membermetadata')

        # Deleting field 'GamingIDs.raptrID'
        db.delete_column('memberinfo_gamingids', 'raptrID')

        # Changing field 'GamingIDs.steamID'
        db.alter_column('memberinfo_gamingids', 'steamID', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'GamingIDs.xboxID'
        db.alter_column('memberinfo_gamingids', 'xboxID', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'GamingIDs.xfireID'
        db.alter_column('memberinfo_gamingids', 'xfireID', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'GamingIDs.psnID'
        db.alter_column('memberinfo_gamingids', 'psnID', self.gf('django.db.models.fields.CharField')(max_length=50))
